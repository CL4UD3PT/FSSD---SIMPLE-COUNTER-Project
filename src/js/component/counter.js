...
export const Counter = (props) => {
    ...
    return (
        <>
            <h1 className={`col px-3 py-4 m-1 text-dark ${props.modeCountdown ? "bg-warning" : "bg-info"} bg-gradient rounded-3`}><i className={`fa-solid ${props.modeCountdown ? "fa-hourglass-start" : "fa-stopwatch"}`}></i></h1>
